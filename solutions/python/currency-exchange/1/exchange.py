...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    money_rate = exchange_money(budget, (exchange_rate * (spread / 100) + exchange_rate))
    bills_value = get_value_of_bills(denomination, get_number_of_bills(money_rate, denomination))
    return bills_value
