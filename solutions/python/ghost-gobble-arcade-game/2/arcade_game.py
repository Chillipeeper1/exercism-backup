...
def lose(power_pellet_active, touching_ghost):
    ...
    """
    check_eat_ghost = eat_ghost(power_pellet_active, touching_ghost)
    if check_eat_ghost: 
        return False
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    check_lose = lose(power_pellet_active, touching_ghost)
    if has_eaten_all_dots and check_lose == False: 
        return True
